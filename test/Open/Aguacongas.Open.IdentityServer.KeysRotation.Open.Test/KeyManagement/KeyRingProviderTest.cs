...
public class KeyRingProviderTest
{
    ...
    public void CreateCacheableKeyRing_NoGenerationRequired_DefaultKeyExpiresAfterRefreshPeriod()
    {
        ...
        var keyRingProvider = SetupCreateCacheableKeyRingTestAndCreateKeyManager(
            ...
            getCacheExpirationTokenReturnValues: [expirationCts.Token],
            getAllKeysReturnValues: [allKeys],
        ...
        Assert.Equal(["GetCacheExpirationToken", "GetAllKeys", "ResolveDefaultKeyPolicy"], callSequence);
    }
    ...
    public void CreateCacheableKeyRing_GenerationRequired_NoDefaultKey_CreatesNewKeyWithImmediateActivation()
    {
        ...
        var keyRingProvider = SetupCreateCacheableKeyRingTestAndCreateKeyManager(
            callSequence: callSequence,
            getCacheExpirationTokenReturnValues: [expirationCts1.Token, expirationCts2.Token],
            getAllKeysReturnValues: [allKeys1, allKeys2],
            createNewKeyCallbacks: [Tuple.Create((DateTimeOffset)now, (DateTimeOffset)now + TimeSpan.FromDays(90), CreateKey())],
            resolveDefaultKeyPolicyReturnValues:
            [
        ...
        Assert.False(CacheableKeyRing<RsaEncryptorConfiguration, RsaEncryptor>.IsValid(cacheableKeyRing, now));
        Assert.Equal(["GetCacheExpirationToken", "GetAllKeys", "ResolveDefaultKeyPolicy", "CreateNewKey", "GetCacheExpirationToken", "GetAllKeys", "ResolveDefaultKeyPolicy"], callSequence);
    }
    ...
    public void CreateCacheableKeyRing_GenerationRequired_NoDefaultKey_CreatesNewKeyWithImmediateActivation_StillNoDefaultKey_ReturnsNewlyCreatedKey()
    {
        ...
        var keyRingProvider = SetupCreateCacheableKeyRingTestAndCreateKeyManager(
            callSequence: callSequence,
            getCacheExpirationTokenReturnValues: [expirationCts1.Token, expirationCts2.Token],
            getAllKeysReturnValues: [allKeys, allKeys],
            createNewKeyCallbacks: [Tuple.Create((DateTimeOffset)now, (DateTimeOffset)now + TimeSpan.FromDays(90), newlyCreatedKey)],
            resolveDefaultKeyPolicyReturnValues:
            [
                Tuple.Create((DateTimeOffset)now, (IEnumerable<IKey>)allKeys, new DefaultKeyResolution()
                {
    ...
    public void CreateCacheableKeyRing_GenerationRequired_NoDefaultKey_KeyGenerationDisabled_Fails()
    {
        ...
        var keyRingProvider = SetupCreateCacheableKeyRingTestAndCreateKeyManager(
            callSequence: callSequence,
            getCacheExpirationTokenReturnValues: [CancellationToken.None],
            getAllKeysReturnValues: [allKeys],
            createNewKeyCallbacks: [
    ...
    public void GetCurrentKeyRing_NoExistingKeyRing_HoldsAllThreadsUntilKeyRingCreated()
    {
        ...
        ManualResetEventSlim mreBackgroundThreadHasCalledGetCurrentKeyRing = new();
        ManualResetEventSlim mreForegroundThreadIsCallingGetCurrentKeyRing = new();
    ...
    public void GetCurrentKeyRing_WithExpiredExistingKeyRing_UpdateFails_ThrowsButCachesOldKeyRing()
    {
        ...
        Assert.Throws<Exception>(() => keyRingProvider.GetCurrentKeyRingCore(throwKeyRingTime));
