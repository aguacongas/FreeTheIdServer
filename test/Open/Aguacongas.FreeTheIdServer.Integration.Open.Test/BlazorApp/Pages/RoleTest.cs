...
using Xunit;
using RolePage = Aguacongas.FreeTheIdServer.BlazorApp.Pages.Role.Role;

namespace Aguacongas.FreeTheIdServer.IntegrationTest.BlazorApp.Pages
{
    [Collection(BlazorAppCollection.Name)]
    public class RoleTest : EntityPageTestBase<RolePage, FreeTheIdServer.BlazorApp.Models.Role>
    {
        public override string Entity => "role";

        public RoleTest(FreeTheIdServerFactory factory) : base(factory)
        {
        }
