...
namespace Aguacongas.FreeTheIdServer.IntegrationTest.BlazorApp
{
    public class FreeTheIdServerFactory : WebApplicationFactory<AccountController>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureAppConfiguration(webBuilder =>
                ...
                .Configure((context, configureApp) =>
                {
                    ...
                    configureApp.UseFreeTheIdServer(context.HostingEnvironment, context.Configuration);
                });
        }
    ...
    public class BlazorAppCollection : ICollectionFixture<FreeTheIdServerFactory>
    {
