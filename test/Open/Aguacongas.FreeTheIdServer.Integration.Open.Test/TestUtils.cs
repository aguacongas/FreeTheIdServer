...
namespace Aguacongas.FreeTheIdServer.IntegrationTest
{
    public static class TestUtils
    {
        public static IConfigurationRoot CreateApplicationConfiguration(HttpClient httpClient)
        {
            var appConfigurationDictionary = new Dictionary<string, string?>
            {
                ...
                ["ProviderOptions:ClientId"] = "FreeTheIdServeradmin",
                ["ProviderOptions:DefaultScopes[0]"] = "openid",
                ["ProviderOptions:DefaultScopes[1]"] = "profile",
                ["ProviderOptions:DefaultScopes[2]"] = "FreeTheIdServeradminapi",
                ...
                ["SettingsOptions:TypeName"] = "Aguacongas.FreeTheIdServer.BlazorApp.Models.ServerConfig, Aguacongas.FreeTheIdServer.BlazorApp.Infrastructure",
