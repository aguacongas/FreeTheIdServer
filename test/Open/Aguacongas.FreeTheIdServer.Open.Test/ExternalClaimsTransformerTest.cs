    ...
    public class ExternalClaimsTransformerTest
    {
        ...
        private static IServiceCollection CreateServices()
        {
            ...
            var services = new ServiceCollection()
                ...
                .AddLogging()
                .AddTransient<ISConfiguration.IdentityServerOptions>()
                .AddFreeTheIdServerAdminEntityFrameworkStores(options => options.UseInMemoryDatabase(dbId))
