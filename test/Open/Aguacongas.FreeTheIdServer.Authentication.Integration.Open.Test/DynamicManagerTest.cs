...
{
    public class DynamicManagerTest : DynamicManagerTestBase<SchemeDefinition>, IClassFixture<FreeTheIdServerTestFixture>
    {
        private readonly FreeTheIdServerTestFixture _fixture;

        public DynamicManagerTest(ITestOutputHelper output, FreeTheIdServerTestFixture fixture) : base(output)
        {
            _fixture = fixture;
        }
        ...
        protected override DynamicAuthenticationBuilder AddStore(DynamicAuthenticationBuilder builder)
        {
            ...
            return builder.AddFreeTheIdServerStore();
        }
    }
}
