...
namespace Aguacongas.FreeTheIdServer.Identity.UpgradePasswordHasherTest.Extensions;
    ...
    public void AddUpgradePasswordHasher_should_add_upgrade_password_hasher_services()
    {
        ...
        var provider = services.AddArgon2PasswordHasher<string>()
            ...
            .AddUpgradePasswordHasher<string>(options =>
            {
                ...
                options.UsePasswordHasherTypeName = "Aguacongas.FreeTheIdServer.Identity.Argon2PasswordHasher.Argon2PasswordHasher";
            })
