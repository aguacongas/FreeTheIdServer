using Aguacongas.FreeTheIdServer.Identity.UpgradePasswordHasher;
using Microsoft.AspNetCore.Identity;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Options;
using System.Text.Json;

namespace Aguacongas.FreeTheIdServer.Identity.UpgradePasswordHasherTest;
...
public class UpgradePasswordHasherTest
{
    ...
    public void HashPassword_should_hash_password_with_configured_hascher()
    {
        var settings = new UpgradePasswordHasherOptions
        {
            ...
            {
                [0x0C] = "Aguacongas.FreeTheIdServer.Identity.ScryptPasswordHasher.ScryptPasswordHasher"
            },
            UsePasswordHasherTypeName = "Aguacongas.FreeTheIdServer.Identity.ScryptPasswordHasher.ScryptPasswordHasher"
        };
    ...
    public void VerifyHashedPassword_should_return_rehash_needed_on_password_valid_and_configuration_changed()
    {
        var settings = new UpgradePasswordHasherOptions
        {
            ...
            {
                [0x0C] = "Aguacongas.FreeTheIdServer.Identity.ScryptPasswordHasher.ScryptPasswordHasher",
                [0xBC] = "Aguacongas.FreeTheIdServer.Identity.BcryptPasswordHasher.BcryptPasswordHasher"
            },
            UsePasswordHasherTypeName = "Aguacongas.FreeTheIdServer.Identity.BcryptPasswordHasher.BcryptPasswordHasher"
        };
    ...
    public void VerifyHashedPassword_should_return_failed_on_dead_line_expired_and_rehash_needed()
    {
        var settings = new UpgradePasswordHasherOptions
        {
            HashPrefixMaps = new Dictionary<byte, string>
            {
                [0xA2] = "Aguacongas.FreeTheIdServer.Identity.Argon2PasswordHasher.Argon2PasswordHasher",
                [0xBC] = "Aguacongas.FreeTheIdServer.Identity.BcryptPasswordHasher.BcryptPasswordHasher"
            },
