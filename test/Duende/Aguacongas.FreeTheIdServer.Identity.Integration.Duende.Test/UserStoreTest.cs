...
{
    public class UserStoreTest : IdentitySpecificationTestBase<TestUser, TestRole>, IClassFixture<FreeTheIdServerTestFixture>
    {
        private readonly FreeTheIdServerTestFixture _fixture;

        public UserStoreTest(FreeTheIdServerTestFixture fixture, ITestOutputHelper testOutputHelper)
        {
            _fixture = fixture;
