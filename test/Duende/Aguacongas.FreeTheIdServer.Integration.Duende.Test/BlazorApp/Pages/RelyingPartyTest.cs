...
using Xunit;
using RelyingPartyPage = Aguacongas.FreeTheIdServer.BlazorApp.Pages.RelyingParty.RelyingParty;
...
namespace Aguacongas.FreeTheIdServer.IntegrationTest.BlazorApp.Pages
{
    ...
    public class RelyingPartyTest : EntityPageTestBase<RelyingPartyPage, RelyingParty>
    {
        ...
        public RelyingPartyTest(FreeTheIdServerFactory factory) : base(factory)
        {
        }
