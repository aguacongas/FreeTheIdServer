...
using ExternalProvidersPage = Aguacongas.FreeTheIdServer.BlazorApp.Pages.ExternalProviders.ExternalProviders;
...
namespace Aguacongas.FreeTheIdServer.IntegrationTest.BlazorApp.Pages
{
    ...
    public class ExternalProvidersTest : EntitiesPageTestBase<ExternalProvider, ExternalProvidersPage>
    {
        ...
        public ExternalProvidersTest(FreeTheIdServerFactory factory)
            : base(factory)
        {
        }
        ...
        protected override Task PopulateList()
        {
            ...
            {
                await context.Providers.AddAsync(new ExternalProvider
                {
                    Id = GenerateId(),
