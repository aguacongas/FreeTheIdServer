...
using ExternalProviderPage = Aguacongas.FreeTheIdServer.BlazorApp.Pages.ExternalProvider.ExternalProvider;

namespace Aguacongas.FreeTheIdServer.IntegrationTest.BlazorApp.Pages
{
    [Collection(BlazorAppCollection.Name)]
    public class ExternalProviderTest : EntityPageTestBase<ExternalProviderPage, FreeTheIdServer.BlazorApp.Models.ExternalProvider>
    {
        public ExternalProviderTest(FreeTheIdServerFactory factory) : base(factory)
        {
        }
