...
namespace Aguacongas.FreeTheIdServer.IntegrationTest
{
    public class ServiceCollectionExtensionsTest
    {
        ...
        {
            using var factory = new FreeTheIdServerFactory();
        ...
        public async Task SeedData_should_seed_data()
        {
            ...
            using var sut = new HostBuilder()
                ...
                {
                    services.AddFreeTheIdServer(configurationManager);
                }).Build();
            ...
            var result = await clientStore.GetAsync("FreeTheIdServeradmin", new GetRequest());
