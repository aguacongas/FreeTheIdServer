...
using Aguacongas.FreeTheIdServer.Identity.Argon2PasswordHasher;
using Aguacongas.FreeTheIdServer.Identity.BcryptPasswordHasher;
using Aguacongas.FreeTheIdServer.Identity.ScryptPasswordHasher;
...
{
    public static IServiceCollection AddFreeTheIdServer(this IServiceCollection services, ConfigurationManager configurationManager)
    {
...
#pragma warning restore S4830 // Server certificates should be verified during SSL/TLS connections
        ...
        var mutulaTlsOptions = configurationManager.GetSection("IdentityServerOptions:MutualTls").Get<Aguacongas.FreeTheIdServer.BlazorApp.Models.MutualTlsOptions>();
...
#pragma warning restore S4830 // Server certificates should be verified during SSL/TLS connections
    ...
    private static void AddDefaultServices(IServiceCollection services, IConfiguration configuration, DbTypes dbType)
    {
        ...
        {
            services.AddFreeTheIdServerAdminEntityFrameworkStores(options => options.UseDatabaseFromConfiguration(configuration))
