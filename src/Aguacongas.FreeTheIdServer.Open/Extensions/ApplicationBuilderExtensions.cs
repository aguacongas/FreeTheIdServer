...
public static class ApplicationBuilderExtensions
{
    ...
    public static IApplicationBuilder UseFreeTheIdServer(this IApplicationBuilder app, IWebHostEnvironment environment, IConfiguration configuration)
    {
    ...
    private static void ConfigureOpentApi(IConfiguration configuration, IApplicationBuilder child)
    {
        child.UseOpenApi(
            ...
            {
                var settings = configuration.GetSection("SwaggerUiSettings").Get<Aguacongas.FreeTheIdServer.Open.SwaggerUiSettings>();
