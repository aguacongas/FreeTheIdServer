...
namespace Aguacongas.FreeTheIdServer.Identity
{
    ...
    public abstract class FreeTheIdServerUserStoreBase<TUser, TKey, TUserLogin, TUserToken> :
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        protected FreeTheIdServerUserStoreBase(IdentityErrorDescriber describer)
        {
    ...
    [SuppressMessage("Critical Code Smell", "S1006:Method overrides should not change parameter defaults", Justification = "<Pending>")]
    public abstract class FreeTheIdServerUserStoreBase<TUser, TKey, TRole, TUserRole, TUserLogin, TUserToken, TRoleClaim> :
        FreeTheIdServerUserStoreBase<TUser, TKey, TUserLogin, TUserToken>,
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        /// </summary>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/> used to describe store errors.</param>
        protected FreeTheIdServerUserStoreBase(IdentityErrorDescriber describer) : base(describer) { }
