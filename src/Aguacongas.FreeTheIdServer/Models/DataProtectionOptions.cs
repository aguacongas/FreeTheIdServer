...
namespace Aguacongas.FreeTheIdServer.Models
{
    ...
    public class DataProtectionOptions : Microsoft.AspNetCore.DataProtection.DataProtectionOptions
    {
        ...
        public string ApplicationName { get; set; } = "FreeTheIdServer";
    }
    ...
    public class KeyProtectionOptions
    {
        ...
        public string AzureKeyVaultCertificateThumbprint { get; set; }
        public string AzureKeyVaultManagedIdentityClientId { get; set; }
    }
}
