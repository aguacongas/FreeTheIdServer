...
public static class AuthenticationBuilderExtensions
{
    ...
    public static AuthenticationBuilder AddWindows(this AuthenticationBuilder builder)
        => builder.AddWindows(NegotiateDefaults.AuthenticationScheme, configure => { });
    ...
    /// <returns>The original builder.</returns>
    public static AuthenticationBuilder AddWindows(this AuthenticationBuilder builder, Action<WindowsOptions> configureOptions)
    ...
    /// <param name="configureOptions">Allows for configuring the authentication handler.</param>
    /// <returns>The original builder.</returns>
    public static AuthenticationBuilder AddWindows(this AuthenticationBuilder builder, string authenticationScheme, Action<WindowsOptions> configureOptions)
