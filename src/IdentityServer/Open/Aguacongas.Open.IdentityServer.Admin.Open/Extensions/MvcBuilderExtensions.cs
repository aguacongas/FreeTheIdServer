            ...
            services.AddHostedService<SchemeChangeHost>()
                ...
                .AddSwaggerDocument(config =>
                {
                    config.PostProcess = document =>
                    {
                        ...
                        document.Info.Title = "Open.IdentityServer admin API";
                        document.Info.Description = "A web API to administrate your Open.IdentityServer";
                        ...
                        document.Info.License = new NSwag.OpenApiLicense
                        {
                            ...
                            Url = "https://github.com/aguacongas/FreeTheIdServer/blob/master/LICENSE"
                        };
                    };
                    ...
                    config.AddSecurity("oauth", new NSwag.OpenApiSecurityScheme
                    {
                        ...
                        Description = "Open.IdentityServer",
                ...
                .AddOAuth("OAuth", options =>
                {
                    options.Events = new OAuthEvents
                    {
                        ...
                        OnCreatingTicket = async context =>
                        {
                            ...
                            request.Headers.UserAgent.Add(new ProductInfoHeaderValue("FreeTheIdServer", "1.0.0"));
