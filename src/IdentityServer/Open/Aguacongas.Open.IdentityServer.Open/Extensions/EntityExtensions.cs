...
public static class EntityExtensions
{
    public static Client ToClient(this Entity.Client client)
    {
        ...
        return new Client
        {
            ...
            Claims = [.. client.ClientClaims.Select(c => new ClientClaim(c.Type, c.Value))],
            ...
            IdentityProviderRestrictions = [.. client.IdentityProviderRestrictions.Select(r => r.Provider)],
    ...
    public static ApiResource ToApi(this Entity.ProtectResource api)
    {
        ...
        {
            ApiSecrets = api.Secrets != null ? [.. api.Secrets.Select(s => new Secret { Value = s.Value, Expiration = s.Expiration })] : null,
            Description = resources?.FirstOrDefault(r => r.ResourceKind == Entity.EntityResourceKind.Description
            ...
            Scopes = api.ApiScopes != null ? [.. api.ApiScopes.Select(s => s.ApiScopeId)] : null,
            UserClaims = api.ApiClaims != null ? [.. api.ApiClaims.Select(c => c.Type)] : null,
    ...
    public static IdentityResource ToIdentity(this Entity.IdentityResource identity)
    {
        ...
        return new IdentityResource
        {
            ...
            UserClaims = [.. identity.IdentityClaims.Select(c => c.Type)]
        };
    }
    ...
    public static ApiScope ToApiScope(this Entity.ApiScope apiScope)
    {
        ...
        return new ApiScope
        {
            ...
            UserClaims = [.. apiScope.ApiScopeClaims.Select(c => c.Type)],
    ...
    public static bool CorsMatch(this Uri cors, string url)
    {
        ...
        var uri = new Uri(url);
        return uri.Scheme.Equals(cors.Scheme, StringComparison.InvariantCultureIgnoreCase) &&
            uri.Host.Equals(cors.Host, StringComparison.InvariantCultureIgnoreCase) &&
            uri.Port == cors.Port;
    }
