...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddFreeTheIdServerMongoDbStores(this IServiceCollection services, string connectionString)
        {
            ...
            return services
                ...
                .AddFreeTheIdServerMongoDbStores(getDatabase: null);
        }

        public static IServiceCollection AddFreeTheIdServerMongoDbStores(this IServiceCollection services, Func<IServiceProvider, IMongoDatabase> getDatabase)
        {
            if (getDatabase == null)
            {
            ...
            {
                AddFreeTheIdServerMongoDbStores(services, entityType, getDatabase);
            }

            return services;
        }

        private static void AddFreeTheIdServerMongoDbStores(IServiceCollection services, Type entityType, Func<IServiceProvider, IMongoDatabase> getDatabase)
        {
