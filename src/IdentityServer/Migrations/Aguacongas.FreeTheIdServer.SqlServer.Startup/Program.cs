...
var host = Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices((hostContext, services) =>
    {
        ...
        Action<DbContextOptionsBuilder> optionsAction = options => options.UseSqlServer(cn, options => options.MigrationsAssembly("Aguacongas.FreeTheIdServer.Migrations.SqlServer"));
