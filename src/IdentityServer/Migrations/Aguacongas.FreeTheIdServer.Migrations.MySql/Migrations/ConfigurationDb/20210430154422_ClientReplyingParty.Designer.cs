...
namespace Aguacongas.FreeTheIdServer.MySql.Migrations.ConfigurationDb
{
    ...
    [Migration("20210430154422_ClientReplyingParty")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aguacongas.Open.IdentityServer.Store.Entity.Culture", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "en",
                            CreatedAt = new DateTime(2021, 4, 30, 15, 44, 22, 364, DateTimeKind.Utc).AddTicks(4519)
                        });
                });
            ...
            modelBuilder.Entity("Aguacongas.Open.IdentityServer.Store.Entity.Client", b =>
                {
                    b.HasOne("Aguacongas.Open.IdentityServer.Store.Entity.RelyingParty", "Relying")
                        .WithMany("Clients")
