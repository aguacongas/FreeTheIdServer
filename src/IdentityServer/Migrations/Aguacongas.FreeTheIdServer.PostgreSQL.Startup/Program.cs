...
var host = Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices((hostContext, services) =>
    {
        ...
        Action<DbContextOptionsBuilder> optionsAction = options => options.UseNpgsql(cn, options => options.MigrationsAssembly("Aguacongas.FreeTheIdServer.Migrations.PostgreSQL"));
