...
> The project [sample/Aguacongas.FreeTheIdServer.CustomClaimsProvider](../sample/Aguacongas.FreeTheIdServer.CustomClaimsProvider) contains an implementation sample.
...
> To avoid `TypeLoadException` copy *Aguacongas.IdentityServer.Open.dll* or *Aguacongas.IdentityServer.IS4.dll* from your FreeTheIdServer installation folder and reference it in your project:
> ```xml
...
>
>  <ItemGroup>
>    <Reference Include="Aguacongas.IdentityServer.Open">
>      <HintPath>Aguacongas.IdentityServer.Open.dll</HintPath>
>    </Reference>
>  </ItemGroup>
>
>  <ItemGroup>
>    <PackageReference Include="Open.IdentityServer" Version="6.1.7" />
>  </ItemGroup>
> </Project>
> ```
...
"ClaimsProviderOptions": [
    {
        "AssemblyPath": "Aguacongas.FreeTheIdServer.CustomClaimsProviders.dll",
        "TypeName": "Aguacongas.FreeTheIdServer.CustomClaimsProviders.ClaimsProvidersSetup"
    }
]
```
...
Read [Using the API](src/Aguacongas.FreeTheIdServer/README.md#using-the-api) for information on how to configure a public/private cluster.
 ...
 * [Using the API](/src/Aguacongas.FreeTheIdServer.Open/README.md#using-the-api)