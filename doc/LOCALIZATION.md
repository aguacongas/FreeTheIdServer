...
The list of keys and a sample of translatation can be found in [Localization-fr.json](../src/Aguacongas.FreeTheIdServer.Open/Localization-fr.json).
...
They must follow the same structure than [Localization-fr.json](../src/Aguacongas.FreeTheIdServer.Open/Localization-fr.json): an array of key/value pair.
