# FreeTheIdServer Admin Application

This project is the [Blazor Web Assembly](https//blazor.net) application to manage a FreeTheIdServer instance.

## Installation
### From Docker

The application is embedded in the [server's Linux image](SERVER.md#from-docker).  
If you prefer, you can install the [standalone application'sLinux image](https://hub.docker.com/r/aguacongas/FreeTheIdServerapp).  
...
* **Aguacongas.FreeTheIdServer.BlazorApp.Infrastructure** contains application models, services, validators and extensions
* **Aguacongas.FreeTheIdServer.BlazorApp.Components** contains application components
* **Aguacongas.FreeTheIdServer.BlazorApp.Pages.*** contains application pages
...
```json
{
  ...
  "settingsOptions": {
    "typeName": "Aguacongas.FreeTheIdServer.BlazorApp.Models.ServerConfig, Aguacongas.FreeTheIdServer.BlazorApp.Infrastructure",
...
[**sample**](../src/Aguacongas.FreeTheIdServer.Open/wwwroot/welcome-fragment.html)
