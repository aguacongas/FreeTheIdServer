...
> [Open.IdentityServer](https://github.com/RockSolidKnowledge/Open.IdentityServer) is a framework that implements OpenID Connect and OAuth 2.0 protocols for ASP.NET Core applications. It allows you to create your own identity and access management solution that can integrate with various identity providers and APIs.
...
* [Open Web Server documentation](SERVER.md)
