...
Since version 4.7.0 the Open version implements [Server-Side sessions](https://docs.Opensoftware.com/identityserver/v6/ui/server_side_sessions/).
...
See [Server-side Sessions options](https://docs.Opensoftware.com/identityserver/v6/reference/options/#server-side-sessions).
...
Sess [Inactivity Timeout](https://docs.Opensoftware.com/identityserver/v6/ui/server_side_sessions/inactivity_timeout/)
...
[Server-Side sessions](https://docs.Opensoftware.com/identityserver/v6/ui/server_side_sessions/)