...
Write-Host "dotnet sonarscanner begin /k:aguacongas_FreeTheIdServer -o:aguacongas -d:sonar.host.url=https://sonarcloud.io -d:sonar.token=****** -d:sonar.coverageReportPaths=coverage\SonarQube.xml $prArgs -v:$env:Version"
dotnet sonarscanner begin /k:aguacongas_FreeTheIdServer -o:aguacongas -d:sonar.host.url=https://sonarcloud.io -d:sonar.token=$env:sonarqube -d:sonar.coverageReportPaths=coverage\SonarQube.xml $prArgs -v:$env:Version
