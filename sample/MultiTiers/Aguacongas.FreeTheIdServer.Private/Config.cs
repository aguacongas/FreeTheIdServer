    ...
    public static class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            return new ApiResource[]
            {
                ...
                new ApiResource("FreeTheIdServeradminapi", "FreeTheIdServer admin API", new string[] 
                {
                    "name",
                    "role"
                })
        ...
        public static IEnumerable<ApiScope> GetApiScopes()
        {
            return new ApiScope[]
            {
                ...
                new ApiScope("FreeTheIdServeradminapi", "FreeTheIdServer admin API", new string[]
                {
                    "name",
                    "role"
                })
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new[]
            {
                ...
                new Client
                {
                    ...
                    AllowedScopes = { "openid", "profile", "FreeTheIdServeradminapi" },
                ...
                new Client
                {
                    ...
                    AllowedScopes = { "FreeTheIdServeradminapi" },
